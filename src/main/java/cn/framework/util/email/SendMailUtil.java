package cn.framework.util.email;
...
public class SendMailUtil {
     ...
     * 邮件发送服务器
     */
    private static final String MAIL_HOST = SysUtil.nvl(SysUtil.getCacheSysConfig("mail.host").getConfig_value(), "smtp.qq.com");
    /**
     * 邮件传输协议
     */
    private static final String MAIL_TRANSPORT_PROTOCOL = SysUtil.nvl(SysUtil.getCacheSysConfig("mail.transport.protocol").getConfig_value(), "smtp");
    /**
     * 是否验证用户
     */
    private static final String MAIL_SMTP_AUTH = SysUtil.nvl(SysUtil.getCacheSysConfig("mail.smtp.auth").getConfig_value(), "true");
    /**
     * 发送服务器需要身份验证
     */
    private static final String MAIL_DEBUG = SysUtil.nvl(SysUtil.getCacheSysConfig("mail.debug").getConfig_value(), "false");
    /**
     * 验证用户名
     */
    private static final String MAIL_USER = SysUtil.nvl(SysUtil.getCacheSysConfig("mail.user").getConfig_value(), "2584073978@qq.com");
    /**
     * 密码
     */
    private static final String MAIL_PASSWORD = SysUtil.nvl(SysUtil.getCacheSysConfig("mail.password").getConfig_value(), "oafhodfsowtbdibf");
